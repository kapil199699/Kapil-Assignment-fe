      ...
      <div className="footer">
        ...
        <div className="footer-right">
          ...
          <div className="social-media-icon">
            <svg id="my-svg" className="fb" viewBox="0 0 24 24">
            ...
            <svg id="my-svg" className="twitter" viewBox="0 0 24 18">
              <path
            ...
            <svg id="my-svg" className="instagram" viewBox="0 0 24 24" fill="none">
              <path
                fill="#fff"
            ...
            <svg id="my-svg" className="youtube" viewBox="0 0 35 24" fill="none">
              <path
                fill="#fff"
                fill-rule="evenodd"
